/***************************************
RoBoNav  2025 - GPS_UBX_M8N.cpp
Cette version de mai 2025 implante la programmation des GPS directement en code binaire UBX 
Gestion du compas intégré au GPS Ublox M8N
A partir d'octobre 2025 nous ajoutons le support d'un GPS RTK Quectel LC29HDA (voir RTK.h )
****************************************/

#include "GPS_UBX_M8N.h"

HMC5883L compass;       // Compas intégré au GPS
...
bool update_GPS_M8N()
{
  ...
  */}
    ...
    lat_position = ubxMessage.navPvt.lat;
    lng_position = ubxMessage.navPvt.lon;
...
void getGPScoordinates_M8N( double &latitude, double &longitude ) {
  latitude  = lat_position;
  longitude = lng_position;
}
